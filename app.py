...
reconciliation_type = st.sidebar.selectbox(
    "Reconciliation Type",
    [
        "Purchase Register vs GSTR-2B",
        "Sales Register vs GSTR-1"
...
date_tolerance = st.sidebar.number_input(
    "Date Tolerance (Days)",
    min_value=0,
    value=3
)
...
if source_file and target_file:
    ...
    try:
        ...
        source_df = UploadService.load_file(
            source_file
        )

        target_df = UploadService.load_file(
            target_file
        )
